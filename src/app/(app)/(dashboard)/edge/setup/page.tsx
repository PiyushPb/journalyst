      ...
      <div className="px-10 pt-4 w-full">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            {/* SEARCH */}
            <div className="flex items-center gap-2 px-3 py-[6px] rounded-xl bg-[#161616] border border-[#2A2A2A] w-[200px] hover:border-[#3A3A3A] transition-all">
            ...
            {/* COMPARE */}
            <button className="px-4 py-[6px] rounded-xl bg-[#161616] border border-[#2A2A2A] hover:bg-[#1E1E1E] hover:border-[#3A3A3A] transition-all flex items-center gap-2 text-[#C1C1C1]">
              <GitCompare size={15} />
              <span className="hidden sm:inline">Compare Setup</span>
            </button>

            {/* ADD SETUP */}
            <button className="px-4 py-[6px] rounded-xl bg-[#1F1F1F] border border-[#333] hover:bg-[#272727] hover:border-[#444] transition-all flex items-center gap-2 text-[#EAEAEA]">
              <Plus size={15} />
